	...
	<div id="inputContainer">
		...
		<form id="registerForm" action="register.php" method="POST">
			...
			<p>
				...
				<input id="username" name="username" type="text" placeholder="e.g. sarahconnor" required>
			</p>

			<p>
				<?php echo $account->getError("Your first name must be between 2 and 25 characters."); ?>
				<label for="firstName">First name</label>
				<input id="firstName" name="firstName" type="text" placeholder="e.g. Sarah" required>
			</p>

			<p>
				<?php echo $account->getError("Your last name must be between 2 and 25 characters."); ?>
				<label for="lastName">Last name</label>
				<input id="lastName" name="lastName" type="text" placeholder="e.g. Connor" required>
			</p>

			<p>
				<?php echo $account->getError("Your emails do not match."); ?>
				<?php echo $account->getError("The Email entered is invalid."); ?>
				<label for="email">Email</label>
				<input id="email" name="email" type="email" placeholder="e.g. sarahc@gmail.com" required>
			</p>

			<p>
				<label for="email2">Confirm email</label>
				<input id="email2" name="email2" type="email" placeholder="e.g. sarahc@gmail.com" required>
			</p>
